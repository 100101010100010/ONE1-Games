...
function createTab(makeActive = true) {
    ...
    frame.frame.src = "https://luna.amazon.com/";
    ...
    frame.frame.addEventListener('load', () => {
        ...
        if (frame.frame.contentWindow.location.href.includes('https://luna.amazon.com/')) {
            tab.title = "New Tab";
            tab.url = "";
            tab.favicon = null;
        }
...
function updateAddressBar() {
    ...
    const tab = getActiveTab();
    if (bar && tab) {
        bar.value = (tab.url && !tab.url.includes("https://luna.amazon.com/")) ? tab.url : "";
    }
}
