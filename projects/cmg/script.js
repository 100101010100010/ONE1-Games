...
function createTab(makeActive = true) {
    ...
    frame.frame.src = "https://www.coolmathgames.com";
    ...
    frame.frame.addEventListener('load', () => {
        ...
        if (frame.frame.contentWindow.location.href.includes('https://www.coolmathgames.com')) {
            tab.title = "New Tab";
            tab.url = "";
            tab.favicon = null;
        }
...
function updateAddressBar() {
    ...
    const tab = getActiveTab();
    if (bar && tab) {
        bar.value = (tab.url && !tab.url.includes("https://www.coolmathgames.com")) ? tab.url : "";
    }
}
